...
public class AST_STMT_IF extends AST_STMT
{
    ...
    public TEMP IRme() {
        ...
        IRcommand lbl_strt_cmd = new IRcommand_Label(label_start,IR.getInstance().currLine,true,false,false,null,false);
		IR.
		getInstance().
		...
		// [6] If end label
		IRcommand lbl_end_cmd = new IRcommand_Label(label_end,IR.getInstance().currLine,false,false,false,null,false);
		IR.
		getInstance().
