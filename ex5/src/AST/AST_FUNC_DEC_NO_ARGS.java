...
public class AST_FUNC_DEC_NO_ARGS extends AST_FUNC_DEC
{
    ...
    public TEMP IRme(boolean isMethod)
    {
        ...
        // [0] Add scope level to offset table
        ...
        IR.getInstance().Add_IRcommand(new IRcommand_Label(label_func_start,IR.getInstance().currLine,true,true,false,null,isMethod));

        // if (this.inClass) {
        //     // this.methods.insert(label_func_start,label_func_end);
        // }
        ...
        IR.getInstance().Add_IRcommand(new IRcommand_Label(label_func_end,IR.getInstance().currLine,false,true,false,null,isMethod));
