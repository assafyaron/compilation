...
public class AST_CLASS_DEC_SIMPLE extends AST_CLASS_DEC
{
    ...
    public TEMP IRme() 
    {
        ...
        IR.getInstance().extendMap.put(this.className, null);
        ...
        if (classBody == null) {
            IR.getInstance().Add_IRcommand(new IRcommand_New_Class(dst,className,0,IR.getInstance().currLine,null));
        } else {
            classBody.IRme();
            IR.getInstance().Add_IRcommand(new IRcommand_New_Class(dst,className,0,IR.getInstance().currLine,null));
        }
